...
import { ExternalLink, Star, StarHalf, User, Loader2 } from "lucide-react";
...
export default function SellersPage() {
  ...
  return (
    <div
      className="relative bg-[#0A0A0A] min-h-screen text-white selection:bg-rose-500/30 selection:text-white"
    >
      <Navbar />
            ...
            {sellers.map((seller) => (
              ...
              >
                {seller.image ? (
                  <div className="relative h-48 w-full">
                    <Image
                      ...
                      onError={(e) => {
                        e.target.src = "/default-seller.jpg";
                  ...
                  <div className="h-48 w-full bg-gradient-to-br from-zinc-800 to-zinc-900 flex items-center justify-center">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <h2 className="text-xl font-semibold mb-2 text-white">{seller.name}</h2>
                  {seller.description && (
          ...
          <div className="bg-gradient-to-b from-zinc-800/40 to-zinc-900/40 backdrop-blur-sm rounded-xl p-6 border border-zinc-800/50">
            ...
            <ul className="space-y-3 text-white/80">
              <li className="flex items-start gap-3">
                ...
                <p>
                  Sprawdzenie jakości produktów poprzez zamówienia testowe i analizę zdjęć QC
                </p>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-rose-500/10 flex items-center justify-center shrink-0 mt-0.5">
